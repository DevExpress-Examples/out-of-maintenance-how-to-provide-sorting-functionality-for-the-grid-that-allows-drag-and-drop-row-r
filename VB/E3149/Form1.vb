...
' 
' This example extends the example provided in the
' http://www.devexpress.com/scid=E764 article with sorting functionality.
' 
' You can find sample updates and versions for different programming languages here:
' http://www.devexpress.com/example=E3149
...
' 
' This example extends the example provided in the
' http://www.devexpress.com/scid=A2343 article with drag and drop functionality.
' 
' You can find sample updates and versions for different programming languages here:
' http://www.devexpress.com/example=E764
...
'			Me.gridView1.EndSorting += New System.EventHandler(Me.gridView1_EndSorting);
...
'			Me.Load += New System.EventHandler(Me.Form1_Load);
		...
		Private Sub FillDataSet()
			dataTable1.Rows.Add(New Object() { 3, "abstract", 1 })
			dataTable1.Rows.Add(New Object() { 2, "event", 2 })
			dataTable1.Rows.Add(New Object() { 1, "new", 3 })
		...
		Private columnSortingState As New Hashtable()
		...
		Private Sub gridView1_EndSorting(ByVal sender As Object, ByVal e As EventArgs) Handles gridView1.EndSorting
			...
			For rowIndex As Integer = 0 To (TryCast(gridView1.DataSource, DataView)).Count - 1
				Dim dr As DataRowView = (TryCast(gv.DataSource, DataView))(rowIndex)
				Dim rowHandle As Integer = gv.GetRowHandle(rowIndex)
				dr(OrderFieldName) = rowHandle + 1
			Next rowIndex
		End Sub

		Private Sub ClearSorting(ByVal gv As GridView)
			Dim changeSortColumn As Boolean = False
			For i As Integer = 0 To gv.SortInfo.Count - 1
				Dim gc As GridColumnSortInfo = gv.SortInfo(i)
				If gc.Column.FieldName <> OrderFieldName Then
					changeSortColumn = True
					Exit For
				End If
			Next i
			If changeSortColumn Then
				gv.ClearSorting()
