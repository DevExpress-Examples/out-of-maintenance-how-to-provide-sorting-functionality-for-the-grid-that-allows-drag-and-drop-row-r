...
namespace SwapRows
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
        ...
        Hashtable columnSortingState = new Hashtable();
        ...
        void gridView1_EndSorting(object sender, EventArgs e)
        {
            ...
            for (int rowIndex = 0; rowIndex < (gridView1.DataSource as DataView).Count; rowIndex++)
            {
                DataRowView dr = (gv.DataSource as DataView)[rowIndex];
